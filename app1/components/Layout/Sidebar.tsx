...
export function Sidebar() {
    ...
    return (
        <motion.aside
            ...
            className="w-64 bg-gradient-to-b from-gray-900 via-gray-900 to-gray-950 text-white h-screen min-h-screen fixed left-0 top-0 border-r border-gray-800/50 z-20 shadow-2xl flex flex-col"
        >
            ...
            <div className="w-full p-6 border-t border-gray-800/50 bg-gray-900/80 backdrop-blur-sm flex-shrink-0">
